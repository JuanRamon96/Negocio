	...
	<div id="ventaNuevo0" class="modal fade" tabindex="-1" data-width="500">
		<div class="modal-header bg-inverse bd-inverse-darken">
			...
			<h4 class="modal-title"><p id="modAgrepro" style="width: 70%; display: inline-block;">Modificar <b>&nbsp; Inventario</b></p>
		...
		<div class="modal-body">
			<section class="panel">
				<form id="formVentana" action="#" method="post" parsley-validate>
					 <input type="hidden" name="nomPagina" id="nomPagina" value="v_almacenV">						<!-- MODIFICAR NOMBRE DE PAGINA-->
