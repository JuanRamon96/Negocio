	...
	<section recargaReporte="reporte" class="panel corner-flip">
		<header class="panel-heading">
			<h2 style="font-size:3.6vw;"><strong>Productos</strong></h2>
		</header>
	...
	<div id="ventaNuevo0" class="modal fade" tabindex="-1" data-width="700">
		...
		<div class="modal-body">
			<section class="panel">
				<div class="panel-body">	
					<form id="formFoto" enctype="multipart/form-data" action="#" method="post" target="subir_archivos" class="row">
						 <input type="hidden" name="nomPagina" id="nomPaginaB" value="v_productosV">						<!-- MODIFICAR NOMBRE DE PAGINA-->
					...
					<form id="formVentana" action="#" method="post" parsley-validate data-collabel="4" data-label="color" class="row">
						 <input type="hidden" name="nomPagina" id="nomPagina" value="v_productosV">						<!-- MODIFICAR NOMBRE DE PAGINA-->
						...
						<div class="col-sm-12 col-md-6">
							...
							<center>
							<div id="imageOutput">
								<img style="width:160px" id="codigoBarras" name="codigoBarras" src="https://smartpoint.com.mx/siv/archivos/codeBar/codebarA.png" alt="barcode" />
							</div>
							</center>
							</div>
							<div class="form-group">
								...
								<div class="input-group"> <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
									<input data-vertical="left" data-horizontal="top" data-theme="danger" validar="codigo_productosV" name="codigo" id="codigo" type="text" class="form-control valida-campos"  parsley-required="true"  parsley-trigger="focus"  placeholder="C&oacute;digo del producto (&uacute;nico)" >
								</div>
							</div>
							<div class="form-group">
								<label class="control-label">Nombre *</label>
								<input name="nombre" id="nombre" type="text" class="form-control" onchange="$('#nombreB').val($(this).val());" parsley-required="true"  parsley-trigger="focus"  placeholder="Nombre de producto" >
							</div>
							<div class="form-group">
								<label class="control-label">Precio *</label>
								<div class="input-group"> <span class="input-group-addon">$</span>
									<input name="precio" id="precio" type="text" class="form-control dinero"  parsley-required="true"  parsley-trigger="focus"  placeholder="Precio del producto" >
								</div>
							</div>
							<div class="form-group">
						...
						<div class="col-md-6 col-sm-12">
							<div id="divSelec" class="form-group">
								...
								<select name="categoria" id="categoria" class="selectpicker form-control show-menu-arrow show-tick" data-style="btn-inverse">
									<option value="">- Selecciona -</option>
									<option data-icon="fa fa-female" value="Vestidos">Vestidos</option>
		...
		<div class="modal-body">
			<section class="panel">
				<form id="formElimina" action="#" method="post" parsley-validate>
					 <input type="hidden" name="nomPagina" id="nomPagina" value="v_productosV">
