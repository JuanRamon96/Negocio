	...
	<div id="ventaNuevo0" class="modal fade" tabindex="-1" data-width="700">
		<div class="modal-header bg-inverse bd-inverse-darken">
			...
			<h4 class="modal-title"><p id="modAgrepro" style="width: 70%; display: inline-block;">Agregar nuevo <b>&nbsp; Cliente</b></p>
			...
			<section class="panel">
				<div class="panel-body">
					...
					<form id="formFoto" enctype="multipart/form-data" action="#" method="post" target="subir_archivos">
						 <input type="hidden" name="nomPagina" id="nomPaginaB" value="v_clientes">						<!-- MODIFICAR NOMBRE DE PAGINA-->
						...
						<div class="col-md-6" style="float:right;z-index: 2;">
							<center>
					...
					<form id="formVentana" action="#" method="post" parsley-validate>
						 <input type="hidden" name="nomPagina" id="nomPagina" value="v_clientes">						<!-- MODIFICAR NOMBRE DE PAGINA-->
						...
						<div class="panel-body">
							<div class="col-md-6" style="margin-top: -24px;">
								...
								<div class="form-group">
									...
									<input name="numeroExt" id="numeroExt" type="text" class="form-control"  parsley-required="true"  parsley-trigger="change"  placeholder="N&uacute;mero exterior" >
								</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-group">
										...
										<input name="numeroInt" id="numeroInt" type="text" class="form-control"  parsley-required="true"  parsley-trigger="change"  placeholder="N&uacute;mero interior" >
									</div>
									<label class="control-label">L&iacute;mite de crédito </label>
									<div class="input-group">
										<input name="credito" id="credito" type="text" class="form-control numeros" placeholder="Ej. 10">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input name="descuento" id="descuento" type="text" class="form-control numeros" placeholder="Ej. 5.00">
	...
	<div id="ventaEliminar0" class="modal fade" tabindex="-1" data-width="700">
		<div class="modal-header bg-inverse bd-inverse-darken">
			...
			<h4 class="modal-title">Eliminar <strong> Cliente</strong></h4>
		</div>
		<div class="modal-body">
			<section class="panel">
				<form id="formElimina" action="#" method="post" parsley-validate>
					...
					<div class="panel-body">
						<center>
							<p> <h3><strong>¿Desea eliminar este cliente? <br><b id="nomUsuElim"></b></strong></h3></p>
						</center>
					</div>
