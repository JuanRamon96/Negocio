	...
	<div id="ventaNuevo0" class="modal fade" tabindex="-1" data-width="1100">
		...
		<div class="modal-body">
			<section class="panel">
				<form id="formVentana" onsubmit="notaCompraM('tablaComprasMP');" action="#" method="post" parsley-validate>
					 <input type="hidden" name="nomPagina" id="nomPagina" value="v_comprasM">						<!-- MODIFICAR NOMBRE DE PAGINA-->
						...
						<div class="col-md-3">
							...
							<div class="panel-body panel corner-flip" style="border:1px solid rgb(221, 221, 221);border-radius:4px">
								<div id="prodSelec" class="form-group">
									...
									<select name="producto" id="producto" class="selecProdComM selectpicker form-control show-menu-arrow show-tick"  data-size="8" data-live-search="true" data-style="btn-inverse">
										<option value="">- Selecciona -</option>
									</select>
								</div>
								<div class="form-group">
		...
		<div class="modal-body">
			<section class="panel">
				<form id="formElimina" action="#" method="post" parsley-validate>
					 <input type="hidden" name="nomPagina" id="nomPagina" value="v_comprasM">
