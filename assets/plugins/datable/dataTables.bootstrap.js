...
$.extend(true, $.fn.dataTable.defaults, {
	"sFooterCallback": function ( row, data, start, end, display ) {
  ...
  "sDom": "<'row'<'col-lg-6'f><'col-lg-6 text-right'Cl>r>t<'row'<'col-lg-6 align-lg-left align-xs-center'i><'col-lg-6  align-lg-right align-xs-center 'p>>",
  ...
  "oLanguage": {
    ...
    "sInfo": "Se muestra del registro <strong>_START_ </strong>al <strong>_END_</strong> de un total de <strong>_TOTAL_</strong> registros",
    "sInfoEmpty": "Sin registros para mostrar",
	"sInfoFiltered": "(filtrado de un total de <strong> _MAX_ </strong> registros)",
	"sEmptyTable": "Sin registros en para mostrar",
  },
  "fnInitComplete": function (oSettings, json) {
    ...
    if (currentId) {
     ...
     // thisLengthLabel.addClass('control-label col-xs-12 col-sm-7 col-md-6').attr('for', currentId + '_length_select').css('text-align', 'left');
      thisLengthSelect.addClass('form-control selectpicker show-menu-arrow show-tick').attr({'id':currentId + '_length_select','data-width':"100px",'data-style':"btn-inverse"});
