...
$.fn.capletClock = function(options) {
                ...
                return this.each(function() {
				    ...
				    obj.append(analog);
						var d = new Date(),day=d.getDay(),month = d.getMonth(), year = d.getFullYear(),date = d.getDate(),
					...
					setInterval(function() {
						...
						if(options.digital){
							...
							var timeString = hours + ':' + minute + ':' + second +"<small> " + ap+"</small>";
							obj.find(".cl-digital").html(timeString);
							$("#cl-digital-Menuarr").html(timeString);
						}
...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		place: function () {
			...
			var index_highest = 0;
			$('div').each(function () {
				var index_current = parseInt($(this).css("zIndex"), 1000000);
				if (index_current > index_highest) {
					index_highest = index_current;
				}
			});
			var zIndex = index_highest + 10000000;
		...
		var posicion = newBorn.children().children();
		var eltopb = posicion.attr("eltop");
		var elleftb = posicion.attr("elleft");

		if(eltopb == undefined && elleftb == undefined){
			eltopb = "245";
			elleftb = "-10";
		}
			this.picker.css({
